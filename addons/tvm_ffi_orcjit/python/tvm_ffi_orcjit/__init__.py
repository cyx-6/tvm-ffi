...
# The TVM-FFI loader deliberately keeps the DSO local on POSIX. Registration is
# performed by TVM_FFI_STATIC_INIT_BLOCK while the library is loaded; keeping it
# local prevents its statically linked LLVM from interposing with a host copy.
